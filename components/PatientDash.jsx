...
export default function PatientDash(props) {
   ...
   const [rescheduleDisabled, setRescheduleDisabled] = useState(true)
      ...
      var scheduleElements = mySchedule[formatWeek(selectedWeek)].map(session => {               // mapiranje podataka iz testingdata na jsx (html) elemente za ispis
         ...
         return (
            <div className={s.session_card} key={id}>
               ...
               <p className={s.session_more}
                  onClick={() => setSelectedSession(mySchedule[formatWeek(selectedWeek)][id])}>View more
               </p>
            </div>
         )
      })
   ...
   return (
      <div className={s.patient_dash_main}>
         ...
         <div className={s.container_right}>
            ...
            <div className={s.selected_session}>
               ...
               <div className={s.session_buttons}>
                  <button className={`${s.session_button} ${notesDisabled && s.button_disabled}`}>View notes</button>
                  <button className={`${s.session_button} ${rescheduleDisabled && s.button_disabled}`}>Reschedule</button>
